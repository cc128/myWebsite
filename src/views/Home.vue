            ...
            <el-menu class="home-menu" :default-active="activeIndex2" mode="horizontal" :collapse="false" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
                <el-menu-item index="/animation">
                    <div @click="toUrl('/animation')">
                        <svg t="1598322673076" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2110" width="20" height="20">
                            <path d="M954.34296889 111.08579555c9.33319111 61.06453333-9.02940445 70.68103111-55.09802667 28.82901334-55.85237333 27.44433778-70.84032 13.10492445-44.96497777-42.97159111-43.85336889-44.12757333-34.74773333-62.58346667 27.31690666-55.40067556 28.74595555-54.69184 49.36248889-51.78936889 61.84277334 8.74154667 61.62090667 10.30826667 65.25496889 30.58688 10.90332444 60.80170666zM596.98744889 637.40131555c-90.34979555 295.16117333-192.30378667 299.28334222-305.87107556 12.41884445C-15.06872889 654.34737778-50.47751111 557.81376 184.88888889 360.20110222c-98.88199111-292.34858667-18.80632889-356.15175111 240.22129778-191.40266667C670.18410667-16.41130667 755.07939555 40.704 679.79832889 340.12956445c250.35093333 177.87790222 222.74730667 276.97720889-82.81088 297.2717511z m238.59768889-370.78243555c19.85194667-27.51715555 30.79281778-24.7808 32.82944 8.21475555 32.58823111 9.02940445 32.97848889 20.06243555 1.16053333 33.05244445 0.28672 33.10933333-10.41749333 37.18371555-32.11605333 12.21176889-32.40846222 11.42215111-39.41262222 2.91157333-21.00565333-25.49873778-20.31957333-26.04145778-13.94460445-35.36099555 19.13173333-27.98023111zM716.82503111 715.06033778L946.76764445 945.53088c17.31697778 17.3568 17.31697778 45.49859555 0 62.85539555-17.31697778 17.35793778-45.39392 17.35793778-62.71089778 0L654.11299555 777.91573333c-17.31697778-17.3568-17.31697778-45.49859555 0-62.85539555s45.39392-17.3568 62.71203556 0z" p-id="2111" fill="#ffd04b"></path>
                        </svg>
                        &nbsp;
                        <span slot="title">效果集合</span>
                    </div>
                </el-menu-item>
                <el-menu-item v-if="false" index="/video-call">
                ...
                <el-menu-item v-if="false" index="screenCAP">
...
export default {
    ...
    // watch: {
    //     "$route.fullPath": function a(v1, v2) {
    //         if (v1 === "/animation") {
    //             this.isShow = true
    //         }
    //     }
